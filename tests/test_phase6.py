...
class TestModelRouter:
    def _setup_router(self):
        ...
        r.add_model(
            "claude-3-5-sonnet", cost_per_1k=0.003, quality=0.87, latency_p50=900
        )
        return r
    ...
    def test_model_profile_cost_efficiency(self):
        ...
        p = ModelProfile(
            name="test", cost_per_1k_tokens=0.001, quality_score=0.8, latency_p50_ms=500
        )
    ...
    def test_model_profile_free_efficiency(self):
        ...
        p = ModelProfile(
            name="test", cost_per_1k_tokens=0.0, quality_score=0.7, latency_p50_ms=500
        )
...
class TestCostOptimizer:
    ...
    def test_analyze_model_downgrade(self):
        ...
        report = opt.analyze()
        downgrade_recs = [
            r for r in report.recommendations if r["type"] == "model_downgrade"
        ]
    ...
    def test_analyze_caching(self):
        ...
        report = opt.analyze()
        cache_recs = [
            r for r in report.recommendations if r["type"] == "enable_caching"
        ]
...
class TestCostEstimator:
    ...
    def test_estimate_with_max_output(self):
        ...
        e = CostEstimator()
        est = e.estimate(
            "gpt-4o", "Write a long essay about everything", max_output_tokens=50
        )
    ...
    def test_estimate_messages(self):
        ...
        e = CostEstimator()
        est = e.estimate_messages(
            "gpt-4o", [{"role": "user", "content": "What is the capital of France?"}]
        )
        assert est.estimated_input_tokens > 0
        assert est.estimated_cost > 0
    ...
    def test_compare_models(self):
        ...
        e = CostEstimator()
        comparison = e.compare_models(
            "Explain AI", models=["gpt-4o", "gpt-4o-mini", "llama3:8b"]
        )
